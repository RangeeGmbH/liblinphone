...
DaemonCommand("set-sound-card", "set-sound-card default|CallID|conference output|input|ringer <Sound Card Name>",
    ...
    addExample(make_unique<DaemonCommandExample>("set-sound-card default output <Sound Card Name>",
                                        "Status: OK\n"));
    addExample(make_unique<DaemonCommandExample>("set-sound-card default input <Sound Card Name>",
                                        "Status: OK\n"));
    addExample(make_unique<DaemonCommandExample>("set-sound-card default ringer <Sound Card Name>",
                                        "Status: OK\n"));
    addExample(make_unique<DaemonCommandExample>("set-sound-card <CallID> output <Sound Card Name>",
                                        "Status: OK\n"));
    addExample(make_unique<DaemonCommandExample>("set-sound-card <CallID> input <Sound Card Name>",
                                        "Status: OK\n"));
    addExample(make_unique<DaemonCommandExample>("set-sound-card conference output <Sound Card Name>",
                                        "Status: OK\n"));
    addExample(make_unique<DaemonCommandExample>("set-sound-card conference input <Sound Card Name>",
                                        "Status: OK\n"));
}
