...
{
    addExample(make_unique<DaemonCommandExample>("conference-mute 1",
                                        "Status: Ok\n\n"
                                        "Microphone Muted"));
    addExample(make_unique<DaemonCommandExample>("conference-mute",
                                        "Status: Ok\n\n"
                                        "Microphone Muted"));
    addExample(make_unique<DaemonCommandExample>("conference-mute 0",
                                        "Status: Ok\n\n"
                                        "Microphone Unmuted"));
    addExample(make_unique<DaemonCommandExample>("conference-mute 1",
                                        "Status: Error\n\n"
